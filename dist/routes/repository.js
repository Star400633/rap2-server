    ...
    if (tryCache) {
        ...
        repository = yield models_1.Repository.findById(ctx.query.id, {
            ...
            order: [
                ...
                [{ model: models_1.Module, as: 'modules' }, { model: models_1.Interface, as: 'interfaces' }, 'priority', 'asc']
            ]
        });
...
router_1.default.post('/interface/move', (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (op === OP_MOVE) {
        ...
        const newItf = yield models_1.Interface.create(Object.assign({ name: name + '副本' }, otherProps, { moduleId: modId }));
        ...
        for (const property of properties) {
            ...
            yield models_1.Property.create(Object.assign({}, props, { interfaceId: newItf.id, moduleId: modId }));
        }
    }
    ctx.body = {
        data: {
